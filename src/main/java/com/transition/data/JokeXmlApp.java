...
public class JokeXmlApp {
    public static void main(String[] args) throws JAXBException, IOException {
        ...
        while (true) {
            String Menu = """
                    press 0: to create new Joke
                    Press 1: to add Joke to previous jokes
            ...
            switch (num1) {
                ...
                case 0 ->{
                    ...
                    System.out.println("Joke Created and Added to XML file");
                }
                ...
                case 1 -> {
                    ...
                    String content = input.nextLine();
                    Joke joke = new Joke(content);
                    service.addJokesToXmlFile(joke);
                    System.out.println("Joke Created and added to file");
                }

                case 2 -> {
                    service.readAllJokes().forEach(System.out::println);
                }
                case 3 -> {
